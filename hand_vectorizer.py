...
class HandVectorizer:
    ...
    def load_reference_dataset(self, dataset_path="kagglehub/asl_dataset"):
        """Carga el dataset de referencia una sola vez"""
        # Intentar cargar el dataset corregido primero
        try:
            df = pd.read_csv("hand_landmarks_dataset_corrected.csv")
            ...
            try:
                ...
                df = self.process_dataset(dataset_path, "hand_landmarks_dataset.csv")
...
def main():
    ...
    # Configurar rutas
    dataset_path = "kagglehub/asl_dataset"
    ...
    df = vectorizer.process_dataset(dataset_path, output_csv)
