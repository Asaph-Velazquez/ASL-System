...
def main():
    ...
    if confirm == "SI":
        ...
        print(f"1. Copia {output_name}.csv como 'hand_landmarks_dataset_corrected.csv'")
        print(f"2. Copia {output_name}_reference_features.pkl como 'reference_features_optimized.pkl'")
